...
public class Assassin extends Unit {
    ...
    public Assassin(Game game, Player playerOwner, Direction directionFacing, Coordinate coor) {
...
class FighterAbility extends ActiveTargetAbility implements AbilityPower, AbilityRange {

    private final Property<Integer> abilityPowerProperty;
    private final Property<Integer> abilityRangeProperty;

    public FighterAbility(Unit unitOwner, int initialPower, int initialRange, int maxWaitTime) {
