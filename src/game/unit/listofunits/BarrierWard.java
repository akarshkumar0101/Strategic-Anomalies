...
public class BarrierWard extends Unit {

    public BarrierWard(Game game, Player playerOwner, Direction directionFacing, Coordinate coor) {
	...
	Ability ability = new BarrierWardAbility(this, defaultStat.defaultAttackRange, defaultStat.defaultWaitTime);
	return ability;
    }
}

class BarrierWardAbility extends ActiveTargetAbility implements AbilityRange {

    private final Property<Integer> abilityRangeProperty;

    public BarrierWardAbility(Unit unitOwner, int initialRange, int maxWaitTime) {
