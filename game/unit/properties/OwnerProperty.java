...
public class OwnerProperty extends Property<Player> {
	...
	public void setOwner(Player newPlayer) {
		if (getCurrentPropertyValue().equals(newPlayer))
			return;
		Player oldPlayer = getCurrentPropertyValue();
		setPropertyValue(newPlayer);
		propertyChanged(oldPlayer, getCurrentPropertyValue());
	}
